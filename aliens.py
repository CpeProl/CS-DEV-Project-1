...
class Alien():        #Classe alien, reprend plusieurs fonction de la classe Vaisseau. Pas d'héritage pour simplifier.
...
class Squadron():        #Comportement des aliens en escouades. Déplacements en groupes... etc
